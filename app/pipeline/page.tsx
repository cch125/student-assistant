...
export default function PipelinePage() {
  ...
  return <main className="page"><section className="panel"><h1>数据流程看板</h1><p className="lede">实时 RAGFlow 运行状态与当前 GitHub 版本知识库快照。</p>
    ...
    <h3>智能检索编排</h3><div className="graph-flow"><div><strong>输入</strong><span>学生问题</span></div><b>→</b><div><strong>RAGFlow</strong><span>知识检索</span></div><b>→</b><div><strong>Harness</strong><span>来源与分数质检</span></div><b>→</b><div><strong>Loop</strong><span>最多改写 2 次</span></div><b>→</b><div><strong>结束</strong><span>回答或拒答</span></div></div>
